...
create table tax_background_check (tax_identification_number VARCHAR(15) NOT NULL, tax_last_fiscal_gross_php DECIMAL(15,2) NOT NULL, tax_first_name VARCHAR(50) NOT NULL, tax_last_name VARCHAR(50) NOT NULL, tax_rdo VARCHAR(10) NOT NULL);